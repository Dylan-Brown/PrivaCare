...
const MEDICATION_ICONS: { group: string; icons: IconEntry[] }[] = [
  {
    group: "Pill Shapes",
    icons: [
      { icon: "mci:pill",              label: "Capsule"    },
      { icon: "mci:pill-multiple",     label: "Multiple"   },
      { icon: "mci:circle-outline",    label: "Oval"       },
      { icon: "mci:circle",            label: "Round"      },
  ...
  },
  {
    ...
    icons: [
      ...
      { icon: "mci:eyedropper",            label: "Dropper"   },
  ...
  },
  {
    ...
    icons: [
      ...
      { icon: "ion:fitness-outline",   label: "Active"     },
    ],
  },
];
